    ...
    <>
      <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden">
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10 flex flex-col justify-between">
            <div className="text-center mb-4">
              <h1 className="font-bold text-3xl text-gray-900">ورود</h1>
              <p>اطلاعات خود را برای ورود وارد کنید</p>
            </div>
            <div>
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    ...
                    <input
                      type="email"
                      className="w-full -mr-10 pr-10 pl-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-rose-500"
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <button disabled={loading}
                    className={`${loading ? "select-none opacity-50 cursor-not-allowed " : "cursor-pointer"} flex items-center justify-center gap-2 w-full  mx-auto bg-rose-500  text-white rounded-lg px-3 py-3 font-semibold `}
